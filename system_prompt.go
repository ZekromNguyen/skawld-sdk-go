...
const toolProtocolBlock = `Tool use protocol:
...
func buildUserMessage(prompt string, images []RunImage) core.Message {
	...
	for _, img := range images {
		if img.URL != "" {
			content = append(content, core.ContentBlock{Type: core.BlockImage, Source: &core.ImageSource{Type: "url", URL: img.URL}})
		} else if img.Data != "" {
			content = append(content, core.ContentBlock{Type: core.BlockImage, Source: &core.ImageSource{Type: "base64", MediaType: img.MediaType, Data: img.Data}})
		}
	}
